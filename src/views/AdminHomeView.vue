<template>
    <div class="about">
      <h1 v-if="isAuthenticated">Admin Home</h1>
      <p v-if="isAuthenticated">
        Welcome to Shangqian Du's A2 Admin Home page.
      </p>
      <h1 v-else>Access Denied</h1>
      <p v-else>You must be logged in to view this page.</p>
      <button v-else @click="goToLogin">Login</button>
    <button v-if="isAuthenticated" @click="UserInformation" class="btn btn-primary" >User Information</button>
